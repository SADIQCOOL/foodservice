...
import com.example.foodservice.ViewHolder.OrderViewHolder;
...
DatabaseReference requests;
    ...
    private void loadOrders(String phone) {
        ...
        adapter = new FirebaseRecyclerAdapter<Request, OrderViewHolder>(
            ...
            @Override
            protected void populateViewHolder(OrderViewHolder viewHolder, Request model, int positon) {

                viewHolder.txtOrderId.setText(adapter.getRef(positon).getKey());
